...
背景还是...
我是用Macbook 工作，每天离开公司后把电脑带回家，会使用Shadowsocks 来自动翻墙。这样就有频繁切换代理的需求。
...
当然如果需要代理的软件太多 ， 可以直接使用 Proxifier 来解决更为优雅，Proxifier 的解决思路是收集软件调用到的底层命令，针对这些命令来使用智能代理的功能。具体可以参考 http://km.oa.com/group/MacOS/articles/show/156377 。
